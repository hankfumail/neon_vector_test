...
#ifndef __ARM_CMPLX_MULT_CMPLX_F32_DOT2A_H_
#define __ARM_CMPLX_MULT_CMPLX_F32_DOT2A_H_
...
void arm_cmplx_mult_cmplx_f32_dot2a(
  unsigned int numSamples);



#endif /* __ARM_CMPLX_MULT_CMPLX_F32_DOT2A_H_  */
