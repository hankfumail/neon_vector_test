...
#ifndef __ARM_CMPLX_MULT_CMPLX_F32_DOT5_H_
#define __ARM_CMPLX_MULT_CMPLX_F32_DOT5_H_
...
void arm_cmplx_mult_cmplx_f32_dot5(
  unsigned int numSamples);



#endif /* __ARM_CMPLX_MULT_CMPLX_F32_DOT5_H_  */
