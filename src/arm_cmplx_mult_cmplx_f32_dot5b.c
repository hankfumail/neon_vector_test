 ...
 */
// __INLINE
void arm_cmplx_mult_cmplx_f32_dot5b(
  unsigned int numSamples )
{
  ...
  float32x4x2_t out1, out2, out3;          /* Temporary variables to stroe output result */
  ...
  while(blkCnt > 0u)
  {
	...
	*/
    ...
    C5 = vmlaq_f32(C5, out2.val[0], out3.val[0]);
    /* multiply 4 samples at a time from A1 imaginary input with B1 imaginary input */
    //C2 = vmulq_f32(out2.val[1], out3.val[1]);
    C6 = vmlaq_f32(C6, out2.val[1], out3.val[1]);
    ...
    C7 = vmlaq_f32(C7, out2.val[1], out3.val[0]);
   /* multiply 4 samples at a time from A1 real input with B1 imaginary input */
	//C4 = vmulq_f32(out2.val[0], out3.val[1]);
	C8 = vmlaq_f32(C8, out2.val[0], out3.val[1]);
